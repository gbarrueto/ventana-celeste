...
Issues live in GitHub Issues on `gbarrueto/ventana-celeste` (uses the `gh` CLI). See `docs/agents/issue-tracker.md`.
...
what exists; anything pending goes in `docs/backlog.md`.
