// Lightweight client-side QR Code Generator (Kazuhiko Arase implementation)
(function(root, factory) {
  ...
  proto.createSvgTag = function(cellSize, margin) {
    cellSize = cellSize || 4;
    ...
    svg += '<rect width="100%" height="100%" fill="#ffffff" rx="12" ry="12"/>';
    svg += '<path d="';
  ...
  return function(typeNumber, errorCorrectionLevel) {
    var t = typeNumber || 0;
    var e = 0; // L:1, M:0, Q:3, H:2 -> default M (0)
    if (typeof errorCorrectionLevel === 'string') {
      e = { L: 1, M: 0, Q: 3, H: 2 }[errorCorrectionLevel.toUpperCase()] || 0;
    }
    return new QRCodeModel(t, e);
  };
}));
